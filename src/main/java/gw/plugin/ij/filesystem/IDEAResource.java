...
public abstract class IDEAResource implements IResource
{
  ...
  IDEAResource( @NotNull VirtualFile virtualFile )
  {
    _virtualFile = checkNotNull( virtualFile );
    _path = checkNotNull( FileUtil.removeJarSeparator( virtualFile.getPath() ) );
  }

  IDEAResource( String dir )
  {
    _path = checkNotNull( dir );
  }
